...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    section: Schema.Attribute.Enumeration<['story', 'event', 'impact']>;
...
export interface ApiContactInfoContactInfo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    emailNote: Schema.Attribute.String;
...
export interface ApiCouncilorCouncilor extends Struct.CollectionTypeSchema {
  collectionName: 'councilors';
  info: {
    displayName: 'Councilor';
    pluralName: 'councilors';
    singularName: 'councilor';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiEventRegistrationEventRegistration
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    volunteerCommitment: Schema.Attribute.Enumeration<
      ['event_only', 'ongoing']
    >;
  };
}
...
export interface ApiTimeLineEntryTimeLineEntry
  extends Struct.CollectionTypeSchema {
  collectionName: 'time_line_entries';
  info: {
    displayName: 'TimeLineEntry';
    pluralName: 'time-line-entries';
    singularName: 'time-line-entry';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::time-line-entry.time-line-entry'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiVendorRegistrationVendorRegistration
  extends Struct.CollectionTypeSchema {
  collectionName: 'vendor_registrations';
  info: {
    displayName: 'VendorRegistration';
    pluralName: 'vendor-registrations';
    singularName: 'vendor-registration';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    needsSpace: Schema.Attribute.Boolean;
    offering: Schema.Attribute.Text;
    phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiVolunteerRegistrationVolunteerRegistration
  extends Struct.CollectionTypeSchema {
  collectionName: 'volunteer_registrations';
  info: {
    displayName: 'VolunteerRegistration';
    pluralName: 'volunteer-registrations';
    singularName: 'volunteer-registration';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::volunteer-registration.volunteer-registration'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    selectedEvents: Schema.Attribute.JSON;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::councilor.councilor': ApiCouncilorCouncilor;
      'api::donation.donation': ApiDonationDonation;
      'api::event-registration.event-registration': ApiEventRegistrationEventRegistration;
      'api::event.event': ApiEventEvent;
      'api::time-line-entry.time-line-entry': ApiTimeLineEntryTimeLineEntry;
      'api::vendor-registration.vendor-registration': ApiVendorRegistrationVendorRegistration;
      'api::volunteer-registration.volunteer-registration': ApiVolunteerRegistrationVolunteerRegistration;
