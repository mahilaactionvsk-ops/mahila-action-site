import svgPaths from "./svg-79ogrqk54i";
          ...
          <div className="h-[548.826px] relative w-[695.503px]">
            <div className="absolute inset-[-2.66%_-2.2%_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 710.79 563.451">
                <path d={svgPaths.p3cbd4000} fill="var(--stroke-0, #AE5F4F)" id="Vector 4" />
              </svg>
            </div>
          </div>
        </div>
...
function Hero() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 pt-[150px] top-[101px] w-[1440px]" data-name="hero">
      <HeroSection />
    </div>
  );
}
...
function Text() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="text">
      <p className="[word-break:break-word] capitalize font-['Fraunces:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[48px] text-black whitespace-nowrap" style={{ fontVariationSettings: '"SOFT" 0, "WONK" 1' }}>
...
function ImpactDescription() {
  return (
    <div className="content-stretch flex flex-col gap-[35px] items-center relative shrink-0" data-name="Impact Description">
      <Text />
      <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.8] not-italic opacity-85 relative shrink-0 text-[20px] text-black text-center tracking-[-0.4px] w-[744px]">
...
function ImpactContent() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[1152px]" data-name="impact-content">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[40px] not-italic relative shrink-0 text-[15px] text-black whitespace-nowrap">Our Impacts</p>
      <ImpactDescription />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="absolute bg-[#b66e5f] content-stretch flex items-start left-[8px] p-[12px] rounded-[16px] size-[56px] top-[8px]">
...
function Frame3() {
  return (
    <div className="absolute bg-[#b66e5f] content-stretch flex items-start left-[8px] pb-[12px] pt-[13px] px-[12px] rounded-[8px] size-[56px] top-[8px]">
      <Frame2 />
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="absolute bg-[#b66e5f] content-stretch flex items-start left-[8px] p-[12px] rounded-[8px] size-[56px] top-[8px]">
      <SystemMovingDesk />
    </div>
  );
}
...
function ImpactCardContainer() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[1319px]" data-name="Impact Card Container">
      <div className="bg-white mr-[-8px] overflow-clip relative rounded-[20px] shrink-0 size-[311px]">
      ...
      <div className="bg-white overflow-clip relative rounded-[20px] shrink-0 size-[311px]">
        <div className="absolute h-[344px] left-[-139px] top-0 w-[516px]" data-name="national-cancer-institute-N_aihp118p8-unsplash 2">
...
function OurImpact() {
  return (
    <div className="absolute content-stretch flex flex-col items-center justify-center left-0 top-[1609px] w-[1440px]" data-name="our-impact">
      <ImpactSectionCards />
    </div>
  );
}
...
function UpcomingEvents1() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-normal items-start relative shrink-0 text-black w-full" data-name="Upcoming Events">
...
function UpcomingEvents() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-0 top-[2365px] w-[1440px]" data-name="upcoming-events">
      <EventsContent />
    </div>
  );
}
...
function StoriesContainer() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-normal items-center relative shrink-0 text-black w-[1152px]" data-name="Stories Container">
...
function CommunityStories() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-0 top-[2903px] w-[1440px]" data-name="community-stories">
      <StoriesContent />
    </div>
  );
}
...
function DonationFormContainer() {
  return (
    <div className="bg-[#f4efe7] content-stretch flex flex-col gap-[30px] items-start justify-center px-[20px] py-[30px] relative rounded-[20px] shrink-0 w-[445px]" data-name="Donation Form Container">
      ...
      <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[405px]" data-name="Contribution Option Container">
...
function StoryCardContainer1() {
  return (
    <div className="content-stretch flex gap-[37px] items-center justify-center relative shrink-0" data-name="Story Card Container">
      <TakeActionContent />
...
function ContentSection() {
  return (
    <div className="absolute content-stretch flex flex-col items-center justify-center left-0 pt-[150px] top-[3967px] w-[1440px]" data-name="Content Section">
      <StoryCardContainer1 />
    </div>
  );
}
...
function Footer() {
  return (
    <div className="absolute content-stretch flex flex-col items-start justify-center left-0 pt-[150px] top-[4893px] w-[1440px]" data-name="footer">
      <FooterContainer />
    </div>
  );
}
...
function Stats() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 pt-[150px] top-[1245px] w-[1440px]" data-name="stats">
...
function Frame9() {
  return (
    <div className="content-stretch flex gap-[12px] items-center justify-center relative shrink-0">
      ...
      <div className="content-stretch flex items-center justify-center px-[20px] py-[16px] relative shrink-0" data-name="menu-item">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[16px] text-black whitespace-nowrap">Who are We</p>
      </div>
      ...
      <button className="content-stretch cursor-pointer flex items-center justify-center px-[20px] py-[16px] relative shrink-0" data-name="menu-item">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[16px] text-black text-left whitespace-nowrap">Stories</p>
      </button>
      <button className="content-stretch cursor-pointer flex items-center justify-center px-[20px] py-[16px] relative shrink-0" data-name="menu-item">
...
export default function Concept2Home() {
  return (
    <div className="bg-[#f4efe7] relative size-full" data-name="concept 2 - Home">
      ...
      <Footer />
      <Stats />
      <div className="absolute bottom-0 h-[5587px] left-0 pointer-events-none top-0">
